 ...
 * @param durationOrGetDuration - The amount of time (in ms) to wait after the callback Promise resolves before invoking
 * the callback again or a function that returns this amount of time.
